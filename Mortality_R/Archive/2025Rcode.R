...
# CONTROLLING FOR SEASONALITY SEASONALITY AND LONG-TERM TREND (WITH Fourier) + TEMPERATURE
...
for(i in 0:14) {
  ...
  mod <- glm(death_count ~ PM2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM1lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ so2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM2lag + so2lag + no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ so2lag + PM2lag + no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ no2lag + PM2lag + so2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM2lag + so2lag +  tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ so2lag + PM2lag +  tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM2lag  + no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ no2lag + PM2lag  + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ so2lag +  no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ no2lag + so2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM1lag + so2lag +  tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ so2lag + PM1lag +  tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM1lag  + no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ no2lag + PM1lag  + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ PM1lag + so2lag + no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ so2lag + PM1lag + no2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
for(i in 0:14) {
  ...
  # DEFINE THE TRANSFORMATION FOR TEMPERATURE
  # LAG SAME AS ABOVE, BUT WITH STRATA TERMS INSTEAD THAN LINEAR
  mod <- glm(death_count ~ no2lag + PM1lag + so2lag + tempdecilelag + fourier, data,
             family = quasipoisson)
...
model7 <- glm(death_count ~ cbPM2unc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model71 <- glm(death_count ~ cbPM1unc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model72 <- glm(death_count ~ cbSOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model73 <- glm(death_count ~ cbNOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model74 <- glm(death_count ~ cbPM2unc + cbSOunc + cbNOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model741 <- glm(death_count ~ cbSOunc + cbPM2unc + cbNOunc +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model742 <- glm(death_count ~ cbNOunc + cbPM2unc + cbSOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model75 <- glm(death_count ~ cbPM2unc + cbSOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model751 <- glm(death_count ~ cbSOunc + cbPM2unc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model76 <- glm(death_count ~ cbPM2unc +  cbNOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model761 <- glm(death_count ~ cbNOunc + cbPM2unc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model77 <- glm(death_count ~  cbSOunc + cbNOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model771 <- glm(death_count ~  cbNOunc + cbSOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model78 <- glm(death_count ~ cbPM1unc + cbSOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model781 <- glm(death_count ~ cbSOunc + cbPM1unc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model79 <- glm(death_count ~ cbPM1unc +  cbNOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model791 <- glm(death_count ~ cbNOunc + cbPM1unc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model70 <- glm(death_count ~ cbPM1unc + cbSOunc + cbNOunc + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model701 <- glm(death_count ~ cbSOunc + cbPM1unc + cbNOunc +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model702 <- glm(death_count ~ cbNOunc + cbPM1unc + cbSOunc + cbtempunc + fourier, data, family = quasipoisson)
...
model8 <- glm(death_count ~ cbpm2constr + cbtempunc + fourier, data, family = quasipoisson)
...
model81 <- glm(death_count ~ cbpm1constr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model82 <- glm(death_count ~ cbsoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model83 <- glm(death_count ~ cbnoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model84 <- glm(death_count ~ cbpm2constr + cbsoconstr + cbnoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model841 <- glm(death_count ~ cbsoconstr + cbpm2constr + cbnoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model842 <- glm(death_count ~ cbnoconstr +  cbpm2constr + cbsoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model85 <- glm(death_count ~ cbpm2constr + cbsoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model851 <- glm(death_count ~ cbsoconstr + cbpm2constr +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model86 <- glm(death_count ~ cbpm2constr + cbnoconstr +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model861 <- glm(death_count ~ cbnoconstr + cbpm2constr +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model87 <- glm(death_count ~ cbsoconstr + cbnoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model871 <- glm(death_count ~ cbnoconstr + cbsoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model88 <- glm(death_count ~ cbpm1constr + cbsoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model881 <- glm(death_count ~ cbsoconstr + cbpm1constr +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model89 <- glm(death_count ~ cbpm1constr + cbnoconstr +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model891 <- glm(death_count ~ cbnoconstr + cbpm1constr +  cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model80 <- glm(death_count ~ cbpm1constr + cbsoconstr + cbnoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model801 <- glm(death_count ~ cbsoconstr + cbpm1constr + cbnoconstr + cbtempunc + fourier, data, family = quasipoisson)
...
# RUN THE MODEL AND OBTAIN PREDICTIONS FOR POLL LEVEL 10ug/m3
model802 <- glm(death_count ~ cbnoconstr +  cbpm1constr + cbsoconstr + cbtempunc + fourier, data, family = quasipoisson)
