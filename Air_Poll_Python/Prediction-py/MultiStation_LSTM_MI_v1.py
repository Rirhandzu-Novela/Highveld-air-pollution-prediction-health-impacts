...
plt.tight_layout()
plt.savefig(f'Results/MultiStation_LSTM_MI{int(MI_THRESHOLD*100)}_Training_Analysis.png', dpi=300, bbox_inches='tight')
print(f"Training analysis saved to: Results/MultiStation_LSTM_MI{int(MI_THRESHOLD*100)}_Training_Analysis.png")
