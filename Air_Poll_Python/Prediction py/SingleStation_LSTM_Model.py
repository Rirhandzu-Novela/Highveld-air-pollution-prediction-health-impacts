...
"""
Single-Station LSTM Production Model - Training and Evaluation
...
try:
    with open('singlestation_lstm_best_params.json', 'r') as f:
...
predictions_df.to_csv('Results/SingleStation_LSTM_Predictions.csv', index=False)
print("Predictions saved to: Results/SingleStation_LSTM_Predictions.csv")
...
if SHAP_AVAILABLE:
    ...
    try:
        ...
        def lstm_single_predict_wrapper(X_flat):
        ...
        explainer = shap.KernelExplainer(lstm_single_predict_wrapper, X_background)
        ...
        plt.title('Single-Station LSTM Model SHAP Feature Importance (Top 20)', fontweight='bold', size=14)
        plt.tight_layout()
        plt.savefig('Results/singlestation_lstm_shap_summary.png', dpi=300, bbox_inches='tight')
        print("SHAP summary plot saved to: Results/singlestation_lstm_shap_summary.png")
        plt.close()
        ...
        plt.title('Single-Station LSTM Model SHAP Feature Importance (Mean)', fontweight='bold', size=14)
        plt.tight_layout()
        plt.savefig('Results/singlestation_lstm_shap_bar.png', dpi=300, bbox_inches='tight')
        print("SHAP bar plot saved to: Results/singlestation_lstm_shap_bar.png")
        plt.close()
...
print("\n" + "="*80)
print("SINGLE-STATION LSTM TRAINING COMPLETE")
print("="*80)
