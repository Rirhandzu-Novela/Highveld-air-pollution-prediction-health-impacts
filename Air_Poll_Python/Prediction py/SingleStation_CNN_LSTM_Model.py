...
plt.tight_layout()
plt.savefig('Results/SingleStation_CNN_LSTM_Training_Analysis.png', dpi=300, bbox_inches='tight')
print("Training analysis saved to: Results/SingleStation_CNN_LSTM_Training_Analysis.png")
...
print("Predictions saved to: Results/SingleStation_CNN_LSTM_Predictions.csv")
