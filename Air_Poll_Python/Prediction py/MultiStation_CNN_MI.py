...
print(f"Metrics saved to: Results/EmaMultiStation_CNN_MI{int(MI_THRESHOLD*100)}_metrics_PM2.csv")
...
plt.tight_layout()
plt.savefig(f'Results/MultiStation_CNN_MI{int(MI_THRESHOLD*100)}_Training_Analysis.png', dpi=300, bbox_inches='tight')
print(f"Training analysis saved to: Results/MultiStation_CNN_MI{int(MI_THRESHOLD*100)}_Training_Analysis.png")
